 ...
 */
            ...
            /**
            *  ProofSessionClosed bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class ProofSessionClosed
        implements org.apache.axis2.databinding.ADBBean{
                ...
                "ns1");
                        ...
                        /**
                        * field for ProofSessionId
                        */

                        
                                    protected java.lang.String localProofSessionId ;
                                
                           /*  This tracker boolean wil be used to detect whether the user called the set method
                          *   for this attribute. It will be used to determine whether to include this field
                           *   in the serialized XML
                           */
                           protected boolean localProofSessionIdTracker = false ;

                           public boolean isProofSessionIdSpecified(){
                               return localProofSessionIdTracker;
                           }
                           ...
                           */
                           public  java.lang.String getProofSessionId(){
                               return localProofSessionId;
                           }
                            ...
                            /**
                               ...
                               * @param param ProofSessionId
                               */
                               public void setProofSessionId(java.lang.String param){
                            localProofSessionIdTracker = param != null;
                                   
                                            this.localProofSessionId=param;
       ...
       public org.apache.axiom.om.OMElement getOMElement (
         ...
         public void serialize(final javax.xml.namespace.QName parentQName,
            ...
            throws javax.xml.stream.XMLStreamException, org.apache.axis2.databinding.ADBException{
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":ProofSessionClosed",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "ProofSessionClosed",
                ...
                if (localProofSessionIdTracker){
                                    namespace = "http://www.vikisolutions.com/";
                                    writeStartElement(null, namespace, "proofSessionId", xmlWriter);
                             

                                          if (localProofSessionId==null){
                                              // write the nil attribute
                                              
                                                     throw new org.apache.axis2.databinding.ADBException("proofSessionId cannot be null!!");
                                                  
                                          }else{

                                        
                                                   xmlWriter.writeCharacters(localProofSessionId);
        ...
        public javax.xml.stream.XMLStreamReader getPullParser(javax.xml.namespace.QName qName)
                 ...
                 if (localProofSessionIdTracker){
                                      elementList.add(new javax.xml.namespace.QName("http://www.vikisolutions.com/",
                                        ...
                                        if (localProofSessionId != null){
                                            elementList.add(org.apache.axis2.databinding.utils.ConverterUtil.convertToString(localProofSessionId));
                                        } else {
                                           throw new org.apache.axis2.databinding.ADBException("proofSessionId cannot be null!!");
                                        }
                                    } if (localExternalApplicationSessionIdTracker){
    ...
    public static class Factory{
        ...
        */
        public static ProofSessionClosed parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ProofSessionClosed object =
                new ProofSessionClosed();
            ...
            try {
                ...
                if (reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","type")!=null){
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"ProofSessionClosed".equals(type)){
                                //find namespace for the prefix
                                java.lang.String nsUri = reader.getNamespaceContext().getNamespaceURI(nsPrefix);
                                return (ProofSessionClosed)com.vikisolutions.www.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://www.vikisolutions.com/","proofSessionId").equals(reader.getName())){
                                
                                    nillableValue = reader.getAttributeValue("http://www.w3.org/2001/XMLSchema-instance","nil");
                                    if ("true".equals(nillableValue) || "1".equals(nillableValue)){
                                        throw new org.apache.axis2.databinding.ADBException("The element: "+"proofSessionId" +"  cannot be null");
                                    }
                                    

                                    java.lang.String content = reader.getElementText();
                                    
                                              object.setProofSessionId(
